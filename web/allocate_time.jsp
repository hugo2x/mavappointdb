<jsp:include page='<%=(String) request.getAttribute("includeHeader")%>' />
	...
	<p align="center"><div class="modal_fade">
		<p><pre><h2><p align="center"><a href="#" data-toggle="modal" data-target="#addTimeSlotModal">Add Timeslot</a>
</p></h2></pre></p><div class="modal_fade">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
						...
						<label id="result"><font style="color:#e67e22" size="4"></font></label>
				</div>
...
<%@include file="templates/footer.jsp"%></div></div></p>