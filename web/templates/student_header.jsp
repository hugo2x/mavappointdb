	<%@include file="top_header.jsp" %>
			<div>
				...
				<li><a href="https://cse.uta.edu/"><font style="color:#e67e22" size="3">Computer Science Department </font></a></li>
				<li><a href="https://www.uta.edu/ee/"><font style="color:#e67e22" size="3">Electrical Science Department </font></a></li>
				</ul>
				...
				<ul class="nav navbar-nav navbar-right">
				<li>
				<li><a href="instruction"><font style="color:#e67e22" size="3" > ChangePassword </font></a></li>
				<li><a href="instruction"><font style="color:#e67e22" size="3"> Instructions </font></a></li>
				<li><a href="feedback"><font style="color:#e67e22" size="3"> Feedback </font></a></li>
				<li><a href="reportbug"><font style="color:#e67e22" size="3"> Report bug </font></a></li>
				</li>
				</ul>
